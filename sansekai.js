...
Menampilkan source code bot yang dipakai`)
        ...
        case "getid":
          ...
          const ids = groupMetadata.participants.map((x) => x.jid);
          const mention = ids.join("\n");
          ...
          break
          case "sendmessage":
            if (!text) return reply(`Kirim pesan ke nomor yang sudah di simpan.\n\nContoh:\n${prefix}${command} 628xxxxxxxxxx Halo`);
            ...
            case "button":
              ...
              const message = await client.prepareMessageFromContent(target, {buttonsMessage: buttonMessage}, {})
